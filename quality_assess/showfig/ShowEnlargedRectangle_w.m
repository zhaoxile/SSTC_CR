function I_rgb = ShowEnlargedRectangle_w(I, LeftUpPoint, RightBottomPoint, Enlargement_Factor, LineWidth, gap)
...
% for j = 1 : c
%     I_rgb(EnlargedShowStartRow:EnlargedShowStartRow + m + 1, EnlargedShowStartColumn:EnlargedShowStartColumn + n - 1,j) = Enlarged(:,:,j); 
% end
...
I_rgb = DrawRectangle(Enlarged, [1,1], [m,n], LineWidth);
